...
CALIBRATION_OVERRIDES: dict = {
    # Auto-generated by `python scripts/calibration_report.py --update-overrides`
    # Last updated: 2026-05-04 16:59
    #
    ...
    # Per-(sport, bucket) overrides
    'baseball_mlb__12%+'                    : 0.627,
    'basketball_nba__12%+'                  : 0.748,
    'basketball_nba__2-4%'                  : 0.500,
    'basketball_nba__4-6%'                  : 1.121,
    'basketball_nba__8-12%'                 : 0.509,
    'icehockey_nhl__12%+'                   : 0.500,
    'soccer_usa_mls__2-4%'                  : 1.222,

    # Sport-level fallbacks
    'baseball_mlb'                          : 0.903,
    'basketball_nba'                        : 0.678,
    'icehockey_nhl'                         : 0.565,
    'soccer_usa_mls'                        : 0.851,
